        ...
        {fullPage && (
          <div className="mb-24">
            <h1 className="text-6xl md:text-9xl font-black text-black tracking-tighter leading-none mb-10">
              Inquiry <br/> <span className="opacity-30 italic font-serif">Channel.</span>
            </h1>
            <p className="text-xl text-slate-500 font-medium max-w-2xl tracking-tight leading-relaxed">Partner with Atlanta's elite workforce agency. High-velocity dispatch, vetted crews, and absolute professional accountability.</p>
          </div>
        )}
          ...
          <div className="lg:w-2/5 bg-black p-16 lg:p-24 text-white relative overflow-hidden">
            ...
            <div className="space-y-14 relative z-10">
              <div className="flex items-start space-x-8">
                ...
                <div>
                  <div className="text-slate-500 text-[9px] uppercase tracking-[0.4em] font-black mb-3">Direct Voice</div>
                  <div className="text-xl font-black tracking-tight mb-1">(404) 447-0926</div>
                  <div className="text-xl font-black tracking-tight opacity-50">(404) 861-7794</div>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-8">
                ...
                <div>
                  <div className="text-slate-500 text-[9px] uppercase tracking-[0.4em] font-black mb-3">Headquarters</div>
                  <div className="text-xl font-black leading-tight">196 Peachtree St SW, #121<br/>Atlanta, GA 30303</div>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-8">
                ...
                <div>
                  <div className="text-slate-500 text-[9px] uppercase tracking-[0.4em] font-black mb-3">Inquiries</div>
                  <div className="text-sm font-bold opacity-80 mb-1">president@vandahire.com</div>
                  <div className="text-sm font-bold opacity-80">accounts@vandahire.com</div>
                </div>
              </div>
            </div>
          </div>
