      ...
      <div className="container mx-auto px-6">
        <header className="max-w-4xl mb-12 lg:mb-24">
          {fullPage ? (
            ...
            <h2 className="text-black text-xs font-black tracking-[0.5em] uppercase mb-10">Atlanta Labor Services</h2>
          )}
          ...
          <p className="text-slate-500 text-xl font-medium max-w-2xl leading-relaxed" itemProp="description">
          ...
          <div className="mt-24 lg:mt-48 p-8 md:p-16 lg:p-32 bg-black text-white rounded-sm">
            <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-24">
              <div className="lg:w-1/2">
                ...
                <button onClick={() => navigate?.('contact')} className="bg-white text-black px-12 py-6 rounded-sm font-black uppercase tracking-[0.2em] text-xs hover:bg-slate-200 transition-all shadow-2xl">Request Workers Today</button>
              </div>
              <div className="lg:w-1/2">
                <div className="grid grid-cols-2 gap-6">
                  <div className="bg-white/5 p-10 border border-white/10">
                    <div className="text-white font-black text-4xl mb-3 tracking-tighter font-serif italic">24/7</div>
                    <div className="text-[10px] uppercase font-black text-slate-500 tracking-[0.4em]">Same-Day Dispatch</div>
                  </div>
                  <div className="bg-white/5 p-10 border border-white/10">
                    <div className="text-white font-black text-4xl mb-3 tracking-tighter font-serif italic">100%</div>
                    <div className="text-[10px] uppercase font-black text-slate-500 tracking-[0.4em]">W-2 Compliant</div>
                  </div>
                  <div className="bg-white/5 p-10 border border-white/10">
                    <div className="text-white font-black text-4xl mb-3 tracking-tighter font-serif italic">Vetted</div>
                    <div className="text-[10px] uppercase font-black text-slate-500 tracking-[0.4em]">Background Checked</div>
                  </div>
                  <div className="bg-white/5 p-10 border border-white/10">
                    <div className="text-white font-black text-4xl mb-3 tracking-tighter font-serif italic">Metro</div>
                    <div className="text-[10px] uppercase font-black text-slate-500 tracking-[0.4em]">Atlanta Coverage</div>
                  </div>
                </div>
              </div>
            </div>
