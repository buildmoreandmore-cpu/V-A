            ...
            <div className="pt-10 space-y-6">
              ...
              <div className="p-8 bg-slate-50 rounded-3xl border border-slate-100">
                ...
                <div className="flex space-x-3 pt-2">
                  ...
                  <a href="https://www.facebook.com/share/1Gmn1CxWh7/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-black text-white flex items-center justify-center rounded-lg" aria-label="Facebook">
